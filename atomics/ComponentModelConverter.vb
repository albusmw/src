...
'''<summary>Extensions for the component model (ProperyGrid e.g.).</summary>
Namespace ComponentModelEx

    '''<summary>Property converter for True to YES and False to NO.</summary>
    Public Class BooleanPropertyConverter_YesNo : Inherits System.ComponentModel.BooleanConverter
        ...
        Public Overrides Function ConvertFrom(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object) As Object
            ...
            If TypeOf value Is String Then
                If CStr(value).ToUpperInvariant = "YES" Then Return True Else Return False
            End If

            'Double to string conversion
            If TypeOf value Is Boolean Then
                If CBool(value) = True Then Return "Yes" Else Return "No"
            End If
        ...
        Public Overrides Function ConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object, ByVal destinationType As Type) As Object
            ...
            'Double to string conversion
            If (TypeOf value Is Boolean AndAlso (destinationType Is GetType(String))) Then
                If DirectCast(value, Boolean) = True Then Return "Yes" Else Return "No"
            End If
    ...
    '''<summary>Property converter for double values</summary>
    ...
    Friend Class Helpers
        ...
        Public Shared Function Convert(ByVal Value As Double, ByVal BaseUnit As String, Optional ByVal FormatString As String = "", Optional ByVal UsekMG As Boolean = True, Optional ByVal UsePlus As Boolean = True, Optional ByVal RegIndep As Boolean = False) As String
            ...
            If UsekMG Then
                ...
                If System.Math.Abs(v) >= 0.000001 And System.Math.Abs(v) < 0.001 Then RetVal = Format(v * 1000000, FormatString) & " µ" & BaseUnit 'mycro
                If System.Math.Abs(v) >= 0.000000001 And System.Math.Abs(v) < 0.000001 Then RetVal = Format(v * 1000000000, FormatString) & " n" & BaseUnit 'nano
                If System.Math.Abs(v) >= 0.000000000001 And System.Math.Abs(v) < 0.000000001 Then RetVal = Format(v * 1000000000000.0#, FormatString) & " p" & BaseUnit 'pico
                If System.Math.Abs(v) >= 0.000000000000001 And System.Math.Abs(v) < 0.000000000001 Then RetVal = Format(v * 1.0E+15, FormatString) & " f" & BaseUnit 'pico
            End If
