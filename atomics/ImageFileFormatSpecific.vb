...
Public Class ImageFileFormatSpecific
    ...
    Public Shared Sub Test48BPP(ByVal FileName As String)
        ...
        Dim b16bpp As New Bitmap(1000, 1000, System.Drawing.Imaging.PixelFormat.Format48bppRgb)
        ...
        For x As Integer = 0 To b16bpp.Width - 1
            For y As Integer = 0 To b16bpp.Height - 1
                ...
                Dim BitPattern As Byte() = BitConverter.GetBytes(CType((x + y) Mod 65536, UInt16))
                bitmapBytes(PixelIdx + 0) = BitPattern(0)
                bitmapBytes(PixelIdx + 1) = BitPattern(1)
                bitmapBytes(PixelIdx + 2) = BitPattern(1)
                bitmapBytes(PixelIdx + 3) = BitPattern(0)
                bitmapBytes(PixelIdx + 4) = BitPattern(1)
                bitmapBytes(PixelIdx + 5) = BitPattern(1)
                RunIdx += 1
            Next y
        Next x
