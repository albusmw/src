...
Namespace Atomic
  ...
  Public Class cRTFGenerator
    ...
    Private RTFText As New System.Text.StringBuilder
        ...
        Private Colors As Collections.Generic.Dictionary(Of Drawing.Color, Integer)
    ...
    Public Property AutoRefresh() As Boolean
      ...
      Set(ByVal value As Boolean)
        MyAutoRefresh = value
        If value = True Then RefreshRequired = True
      End Set
    End Property
    Private MyAutoRefresh As Boolean

    '''<summary>Refresh the associated control if a new text arrives.</summary>
    Public Property AutoRefreshInterval() As Integer
      Get
        Return MyAutoRefreshInterval
      End Get
      Set(ByVal value As Integer)
        MyAutoRefreshInterval = value
        If value > 0 Then
      ...
      End Set
    End Property
    Private MyAutoRefreshInterval As Integer = 100
    ...
    Public Sub Clear()
      RTFText = New System.Text.StringBuilder
    ...
    Private Function AddColor(ByVal NewColor As Drawing.Color) As Integer
      ...
      If Colors.ContainsKey(NewColor) = False Then
        ...
        Colors.Add(NewColor, Colors.Count)
                ...
                Dim AllColors As Collections.Generic.Dictionary(Of Drawing.Color, Integer).KeyCollection = Colors.Keys
    ...
    Public Sub New()
            Colors = New Collections.Generic.Dictionary(Of Drawing.Color, Integer)
